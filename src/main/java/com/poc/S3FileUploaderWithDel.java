...
public class FileUploader {
    ...
    public static void main(String[] args) {
        ...
        try {
            // Delete existing files at the specified S3 key
            deleteExistingFiles(s3Client, bucketName, s3Key);
    ...
    private static void deleteExistingFiles(AmazonS3 s3Client, String bucketName, String s3Key) {
        ...
        do {
            ...
            for (S3ObjectSummary summary : objectListing.getObjectSummaries()) {
                ...
                System.out.println("Deleted file: " + summary.getKey());
            }
